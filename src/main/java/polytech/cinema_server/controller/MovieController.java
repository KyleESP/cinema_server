...
public class MovieController {
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<Movie> deleteByIdMovie(@PathVariable("id") Integer id) {
        Movie movieDeleted = movieService.deleteByIdMovie(id);
        return new ResponseEntity<>(movieDeleted, HttpStatus.OK);
    }
}
